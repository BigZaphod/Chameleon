...
@property (nonatomic, strong) UIColor *selectionIndicatorBackgroundColor; // default is R:52, G:181, B:229
@property (nonatomic, strong) UIColor *selectionIndicatorStripLayerColor; // default is R:52, G:181, B:229
@property (nonatomic, strong) UIColor *selectionIndicatorBoxLayerColor; // default is R:52, G:181, B:229
