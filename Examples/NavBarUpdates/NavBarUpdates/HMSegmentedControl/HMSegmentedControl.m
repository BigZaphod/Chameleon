...
- (void)setDefaults {
    ...
    self.selectionIndicatorBackgroundColor = [UIColor colorWithRed:52.0f / 255.0f green:181.0f / 255.0f blue:229.0f / 255.0f alpha:1.0f];
    self.selectionIndicatorStripLayerColor = [UIColor colorWithRed:52.0f / 255.0f green:181.0f / 255.0f blue:229.0f / 255.0f alpha:1.0f];
    self.selectionIndicatorBoxLayerColor = [UIColor colorWithRed:52.0f / 255.0f green:181.0f / 255.0f blue:229.0f / 255.0f alpha:1.0f];
    ...
    self.selectionLocation = HMSegmentedControlSelectionLocationDown;
    self.type = HMSegmentedControlTypeText;
...
- (void)drawRect:(CGRect)rect {
    ...
    self.selectionIndicatorStripLayer.backgroundColor = self.selectionIndicatorStripLayerColor.CGColor;
    
    self.selectionIndicatorBoxLayer.backgroundColor = self.selectionIndicatorBackgroundColor.CGColor;
    self.selectionIndicatorBoxLayer.borderColor = self.selectionIndicatorBoxLayerColor.CGColor;
    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock: ^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            if (self.selectedSegmentIndex == idx)
                [lbl setTextColor:self.selectedTextColor];
            else
                [lbl setTextColor:self.textColor];
            
            //[lbl setTextFontSize:self.font.pointSize];
            [self addSubview:lbl];
        }];
    }
